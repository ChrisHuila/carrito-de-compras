...
function cargarEvenListeners() {
    ...
    vaciarCarritoBtn.addEventListener('click', () => {
        articulosCarrito = []; // Reseteamos el arrays
        limpiarHTML(); // Eliminamos todo el HTML
    });
}

// Las dos funciones principales son agregar y eliminar
// Funciones
...
function eliminarCurso(e) {
    ...
    if(e.target.classList.contains('borrar-curso')) {
        ...
        carritoHTML(); // Itarar sobre el carrito y mostrar su HTML
    }
}
...
// innerHTML es una forma en la que accedes al HTML
// Elima los cursos del tbody
